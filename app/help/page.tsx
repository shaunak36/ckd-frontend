      ...
      <aside className="fixed inset-y-0 left-0 flex w-64 flex-col border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 z-20">
        ...
        <div className="px-3 pb-4">
          <div className="mb-2 space-y-1">
             ...
             <Link href="/help" className="flex items-center gap-3 rounded-md bg-sky-50 dark:bg-sky-900/30 px-3 py-2 text-sm font-medium text-sky-700 dark:text-sky-400">
      ...
      <div className="flex flex-1 flex-col pl-64">
        <main className="flex-1 p-8">
          <div className="mx-auto max-w-3xl flex flex-col gap-8">
            <div>
              <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-50">Help & Support</h1>
              <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Find answers to common questions or contact support.</p>
            </div>

            <section>
              <h2 className="mb-4 text-lg font-semibold text-slate-900 dark:text-slate-50">Frequently Asked Questions</h2>
              <FaqAccordion />
            </section>

            <section className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm">
              <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-50">Contact Support</h2>
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
                Need help? Email <a href="mailto:support@ckdone.app" className="font-medium text-sky-600 dark:text-sky-400 hover:underline">support@ckdone.app</a>
              </p>
            </section>
          </div>
        </main>
