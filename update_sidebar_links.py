...
old_pattern = re.compile(
    r'<div className="mb-2 space-y-1">.*?Settings.*?Help.*?</div>\s*<div className="flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 p-3">',
    re.DOTALL
)

new_block = """<div className="mb-2 space-y-1">
...
def replace_in_file(filepath):
    # skip settings and help since we already did them correctly (with their active state)
