...
if 'const [userName' not in content:
    content = content.replace('const [userRole, setUserRole] = useState<"doctor" | "patient" | null>(null);', 'const [userRole, setUserRole] = useState<"doctor" | "patient" | null>(null);\n  const [userName, setUserName] = useState("");')
...
content = re.sub(r'return \(\s*<div className="flex min-h-screen flex-col bg-sky-50">\s*<main className="mx-auto flex w-full max-w-4xl flex-1 flex-col gap-8 px-4 py-10 sm:px-8">', sidebar, content)
